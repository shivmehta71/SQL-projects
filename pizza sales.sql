...
-- Q6. join the necessary tables to find the total quantity of each pizza category orderd. 
...
-- Q8. Join relevant tables to find the category-wise distributions of pizzas.
